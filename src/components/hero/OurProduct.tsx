...
import { Icon24Hours, IconArtboard, IconBellRingingFilled, IconBrandAndroid, IconBrandCitymapper, IconBuilding, IconClock24, IconClockBolt, IconColorSwatch, IconCube, IconDots, IconDualScreen, IconEngine, IconLamp, IconLamp2, IconLibraryPlus, IconLighter, IconLineHeight, IconPrismLight, IconScreenShare, IconTemplate, IconTerminal, IconUrgent } from "@tabler/icons-react";
    ...
    <div className="w-[75%] mx-auto py-20">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-6">
        <div className="bg-gray-50 rounded-lg p-5 shadow-lg shadow-gray-200">
          ...
          <h2 className="font-semibold mt-2 text-xl text-center text-gray-600">LED & LCD Display</h2>
        </div>
        <div className="bg-gray-50 rounded-lg p-5 shadow-lg shadow-gray-200">
          <div className="p-1.5 rounded-lg bg-orange-100 text-orange-600">
              <IconClockBolt size={50} className="mx-auto" />
          </div>
          <h2 className="font-semibold mt-2 text-xl text-center text-gray-600">Videotron Rental</h2>
          <div className="mt-1">
        ...
        <div className="bg-gray-50 rounded-lg p-5 shadow-lg shadow-gray-200">
          ...
          <h2 className="font-semibold mt-2 text-xl text-center text-gray-600">Interactive Display</h2>
          <div className="mt-1">
        ...
        <div className="bg-gray-50 rounded-lg p-5 shadow-lg shadow-gray-200">
          ...
          <h2 className="font-semibold mt-2 text-xl text-gray-600 text-center">Lighting Building</h2>
        </div>
        <div className="bg-gray-50 rounded-lg p-5 shadow-lg shadow-gray-200">
          <div className="p-1.5 rounded-lg bg-sky-100 text-sky-600">
            <IconBrandAndroid size={50} className="mx-auto"/>
          </div>
          <h2 className="font-semibold mt-2 text-xl text-center text-gray-600">Software</h2>
        </div>
        <div className="bg-gray-50 rounded-lg p-5 shadow-lg shadow-gray-200">
          <div className="p-1.5 rounded-lg bg-gray-100 text-gray-600">
            <IconDots size={50} className="mx-auto"/>
          </div>
          <h2 className="font-semibold mt-2 text-xl text-center text-gray-600">Lainnya</h2>
        </div>
      </div>
      </div>
