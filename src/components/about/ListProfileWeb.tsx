        ...
        <div className="p-4">
          <p>
            {data?.user_count !== undefined ? (
              <span className="text-4xl font-semibold text-red-600">{`${data.user_count} +`}</span>
            ) : (
              <Loader type="dots" />
            )}
          </p>
        ...
        <div className="p-4">
          <p>
            {data?.contract_count !== undefined ? (
              <span className="text-4xl font-semibold text-teal-600 ">{`${data.contract_count} +`}</span>
            ) : (
              <Loader type="dots" />
            )}
          </p>
        ...
        <div className="p-4">
          <p>
            {data?.product_count !== undefined ? (
              <span className="text-4xl font-semibold text-orange-600">{`${data.product_count} +`}</span>
            ) : (
              <Loader type="dots" />
            )}
          </p>
        ...
        <div className="p-4">
          <p>
            {data?.history_count !== undefined ? (
              <span className="text-4xl font-semibold text-blue-600">{`${data.history_count} +`}</span>
            ) : (
              <Loader type="dots" />
            )}
          </p>
